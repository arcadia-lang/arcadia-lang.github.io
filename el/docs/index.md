...
Η Αρκάδια ακολουθεί την **ονομαστικής-αιτιατικής ευθυγράμμιση**, αλλά **όχι αποκλειστικά**. Ενσωματώνει στοιχεία από την **εργατική-απολυτική ευθυγράμμιση** και **Αυστρονησιακή ευθυγράμμιση**.
...
Σε αντίθεση με τις παραδοσιακές ονομαστικές-αιτιατικές δομές, η σύνταξη της Αρκάδια είναι **συμμετρική**—τόσο το **άμεσο όσο και το έμμεσο αντικείμενο** μπορούν να προαχθούν στη θέση του **υποκειμένου**.
...
graph LR
  ...
  subgraph συμμετέχοντες
    direction TB
    A([**Δωρητής**<br/>_Ο Γιάννης_])
    C([**Αντικείμενο**<br/>_την μπάλα_])
...
Ο **δωρητής, το αντικείμενο και ο παραλήπτης** μπορούν **όλοι** να προαχθούν σε υποκείμενο.

!!! warning "Παραλήπτης"

    Ο παραλήπτης εδώ αναφέρεται στον **παραλήπτη του αντικειμένου**, **όχι στην ενέργεια** αυτή καθαυτή.
