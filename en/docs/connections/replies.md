...
| -------------------------- | -------------------- | --------------------- | ----------------------- | ------------------------- |
| ke _(who/what)_            | ane (no one/nothing) | aye (anyone/anything) | eye (someone/something) | are (everyone/everything) |
| kuál _(which)_             | anuál (none)         | ayuál (any)           | eyuál (some)            | aruál (all)               |
| kove _(where)_             | anove (nowhere)      | ayove (anywhere)      | eyove (somewhere)       | arove (everywhere)        |
| kuandho _(when)_           | anuandho (never)     | ayuandho (anytime)    | eyuandho (sometime)     | aruandho (always)         |
| kuót _(how much/how many)_ | anuót (none)         | ayuót (any amount)    | eyuót (some amount)     | aruót (all)               |
| kume _(how)_               | anume (no way)       | ayume (any way)       | eyume (some way)        | arume (every way)         |
