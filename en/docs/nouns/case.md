...
- **Back Vowels (-a, -o, -u)**:
    - **Bipartite Cases (nominative, ergative, absolutive, accusative, dative, thematic)**: The case suffix's vowel is dropped, retaining the stem's vowel (e.g., _luna-il_ → _lunal_).
