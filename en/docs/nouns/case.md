...
Arcadia employs **eleven grammatical cases**, each marked by a distinct suffix.
...
- **Back Vowels (-a, -o, -u)**:
    - **Consonant Cases (nominative, ergative, absolutive, accusative, dative, thematic)**: The case suffix's vowel is dropped, retaining the stem's vowel (e.g., _luna-il_ → _lunal_).
    - **Vowel Cases (predicative, prepositional, vocative, instrumental, benefactive)**: The stem's final vowel is dropped, retaining the case suffix's vowel (e.g., _luna-is_ → _lunas_).
