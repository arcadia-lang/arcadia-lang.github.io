...
Arcadia has two timeless tenses, **veritas and aorist**, that capture states that **aren't bound by time**.
The difference between them is that veritas
...
On the other hand, **aorist** is used to describe **a typical day or spatially bound events**.
