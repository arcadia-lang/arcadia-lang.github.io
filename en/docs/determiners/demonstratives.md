...
- **_cuando:_** (when)
    ...
    - **Close:** _estuando_ → "Now"
    - **Far:** _essuando_ → "The other time"
    - **Very far/invisible:** _tisuando_ → "In a distant time"
...
!!! note "Deictic Expressions"
    ...
    _"-ove"_, _"-uando"_, and _"-ume"_ are **not true demonstratives**, but are included here due to their close relationship with **deictic expressions**.

---

## **Agreement Rules**

- [x] When combined with a noun, **the demonstrative must agree in number**.
- [x] Demonstratives **do not take case markings** when used with a noun (to avoid redundancy).
- [x] When **used independently**, case marking **is mandatory**.

---

## **"ess" vs. "tis" in Temporal Contexts**

- [x] **"essando"** → Used when referring to **a time within a lifetime**.
- [x] **"tisando"** → Used when referring to **a more distant time or an abstract concept**.

---

## **Examples**

- [x] **Demonstrative with a noun** → No case marking required:
...
- [x] **Demonstrative as a standalone pronoun** → Requires case marking:
