...
Arcadia has **three primary reply words**, each serving a distinct conversational function:

- **si** → **"Yes"** (affirmative response).
- **ni** → **"No"** (negative response).
...
- [x] **Usage of "ack"** → Commonly used in **dialogue** when one wants to **indicate understanding** but avoid committing to a definitive stance.
...
| **cuando** _(when)_            | **anuando** (never)      | **ayuando** (anytime)     | **eyuando** (sometime)      | **aruando** (always)          |
