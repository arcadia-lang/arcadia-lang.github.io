...
<<Arcadia classifies nouns into **five grammatical [classes][class]**, which serve a **structural role** with **minimal semantic influence**:>>
...
<<Arcadia features a **system for generating new nouns** from existing ones, allowing structured expansion of vocabulary.>>
<<The full set of derivational rules is available in the **[noun generation guide][generation]**.>>
