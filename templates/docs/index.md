...
- <$Four-person system:$>
    - <$expanding beyond 1st/2nd/3rd person$>
- <$Timeless tenses:$>
    - <$verbs can be unbound by time$>
- <$Factual conditionals in the past:$>
    - <$e.g., "If it was true (and it was indeed), then..."$>
...
- <$Romance familiarity:$>
    - <$Easy phonetics and orthography for speakers of Spanish, French, etc.$>
- <$Expressive depth:$>
    - <$Nuance is never sacrificed for simplicity.$>
