...
<<The language uses **23 Latin letters**, excluding {{⟨k⟩}}, {{⟨q⟩}}, and {{⟨w⟩}}, along with digraphs and well-defined stress rules to maintain uniformity.>>
...
!!! note "<<Pronunciation Flexibility>>"
    ...
    <<For example, ⟨r⟩ is pronounced as /r/, but distinctions like trilled vs. tapped carry **no functional load**.>>
...
<<To aid pronunciation, **double colons** (_::_) may be used upon the first occurrence of such a name (_mike ::maic::_).>>
