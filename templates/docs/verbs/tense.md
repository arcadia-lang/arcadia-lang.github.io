...
~{Arcadia has a timeless tense, veritas, that captures states that aren't bound by time.}
~{This tense is used for universal truths, scientific facts, or constants.}
~{In indicative mood, it is expressed with the suffix `-uv`.}
