...
In Arcadia, moods are split the the moods in two groups, the main and the secondary.
The main moods cannot be combined between them, but they can be combined with secondary moods.
Unless combined, moods in Arcadia are formed by changing the consonant of the tense suffix.
