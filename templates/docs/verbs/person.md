# 📚 <<Arcadian Verbal Conjugation: Person & Number>>

<<In Arcadia, verbs are conjugated using **person** and **number**, expressed through suffixes attached to the **verb stem**, after the **tense** suffix has been added.>>
...
- **<<Exclusive>>** (_<<we, not you>>_)
- **<<Inclusive>>** (_<<we, including you>>_)
...
- _s-_ → _sav-_ (<<tense suffix>>)
- _savo_: <<I am>>
- _savas_: <<we (including you) are>>
- _savur_: <<everyone is>>
