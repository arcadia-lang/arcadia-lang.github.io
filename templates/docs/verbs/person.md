...
In Arcadia, there are 4 persons: 1st, 2nd, 3rd, and 4th.
...
Arcadia is a pro-drop language, so the pronouns aren't necessary, and should only be used if emphasis is required.
