...
In Arcadia there are 9 aspects, which are used to indicate how the verb's action extends over time.
In Arcadia the aspect is expressed by an aspect word, that precedes the verb.
